 ...
 * @author gvallespir
 */
public class introducirParam extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(introducirParam.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new introducirParam().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton jButtonInsertar3;
